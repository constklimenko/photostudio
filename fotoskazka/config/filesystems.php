...
return [
    ...
    */
    ...
    'disks' => [
        ...
        |----------------------------------------------------------------------
        |
        | Локальный кэш пережатых версий для страниц портфолио:
        |   - "display"  (800px)   — сетка на странице альбома (WebP);
        |   - "lightbox" (1600px)  — полноэкранный просмотр (PNG).
        |
    ...
    */
    ...
    | formats    — формат файла производной для каждого уровня (webp|png);
    ...
    | webp_quality — качество WebP (0-100).
    |
    */
    ...
    'image_cache' => [
        ...
        'png_level' => 6,
        'webp_quality' => (int) env('IMAGE_CACHE_WEBP_QUALITY', 80),
    ],
