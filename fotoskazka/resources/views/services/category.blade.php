...
@if ($category->albums->isNotEmpty())
    <section class="py-24" data-aos="fade-up">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="font-heading text-2xl font-normal tracking-wide text-white mb-8">{{ $category->examples_title ?: 'Примеры работ' }}</h2>
...
@if ($category->show_album_photos && $category->featuredAlbum)
    <section class="py-24 bg-[#111111]" data-aos="fade-up">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <x-site.album-photos :album="$category->featuredAlbum" />
        </div>
    </section>
@endif
...
@if ($category->videos->isNotEmpty())
    <section class="py-24 bg-[#111111]" data-aos="fade-up">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <x-site.videos :videos="$category->videos" title="Видео" />
        </div>
    </section>
@endif
